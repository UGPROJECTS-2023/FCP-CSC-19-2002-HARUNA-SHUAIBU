...
<table cellpadding = "1" cellspacing = "1" id = "resultTable">
	...
	include('../db/dbConnection.php');
		...
		while($row = mysqli_fetch_array($result))
		{
			...
			echo '<td><div align="left">'.$row['TELEPHONE'].'</div></td>';
			echo '<td><div align="left">'.$row['MESSAGE'].'</div></td>';
			echo '<td><div align="left"><a href="#" id = "'.$row['SN'].'" class="delbutton" title = "Click to Delete"> <img src="images/delete.gif"> </a> &nbsp; &nbsp; &nbsp; &nbsp;  <a href = "http//:www.gmail.com" class = ""> Click to reply </a></div></td>';
