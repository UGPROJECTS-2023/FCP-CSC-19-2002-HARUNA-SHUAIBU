...
<!--Feedback Form Start-->
<form name = "feedback" onsubmit = "return validateFormOnSubmit(this)" action = "sendemal.php" method = "post">
...
<center><h2> Feedback Form </h2></center>
            ...
            <span class = "red"> * </span> <label> Name: </label>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<input type="text" name="email" id="email" size="20"/><br><br>
                <span class = "red"> * </span><label>Subject:</label>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<span class = "red"> * </span> <label>Message:</label> <br>
            <textarea name="message" id="message" cols="70" rows="10" placeholder="Type Your Message"></textarea></br><br>
		    <input type="submit" name="submit" id="submit" value="Send Feedback"/></br>
        </form></br>
